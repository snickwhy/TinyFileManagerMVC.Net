    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/FileManager/css").Include(
                "~/Content/css/fileManager/bootstrap.css",
                "~/Content/css/fileManager/bootstrap-lightbox.css",
                "~/Content/css/fileManager/style.css",
                "~/Content/css/fileManager/dropzone.css"
                ));
